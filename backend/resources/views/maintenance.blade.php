...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        <div class="p-8 text-center">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Under Maintenance</h1>
            <p class="text-gray-600 dark:text-gray-300 mb-6">
                {{ config('app.name', 'The application') }} is currently undergoing scheduled maintenance.
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700 dark:text-yellow-300">
                            Expected completion: <span class="font-medium">{{ now()->addHour()->format('g:i A') }} ({{ now()->timezone(config('app.timezone'))->getOffsetString() }})</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-700/30 px-6 py-4 text-center">
            <p class="text-xs text-gray-500 dark:text-gray-400">
                &copy; {{ date('Y') }} {{ config('app.name', 'ResumeRise') }}. All rights reserved.
            </p>
        </div>
    </div>
</body>
