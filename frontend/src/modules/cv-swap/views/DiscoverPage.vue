  ...
  <div class="min-h-screen bg-gray-900 text-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-12">
        <h1 class="text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-300 sm:text-5xl">
          Discover Talent
        </h1>
      ...
      <div class="relative h-[600px] max-w-xl mx-auto">
        <!-- Empty State -->
        <div v-if="profiles.length === 0" class="text-center p-12 bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50">
          <div class="mx-auto flex items-center justify-center h-24 w-24 rounded-full bg-purple-900/30 mb-6">
            <UserGroupIcon class="h-12 w-12 text-purple-400" />
          </div>
          <h3 class="text-2xl font-bold text-white mb-2">No more profiles</h3>
          <p class="text-gray-400 mb-6 max-w-md mx-auto">Check back later for new candidates or adjust your search filters</p>
          <button 
          ...
          <div class="relative h-80 overflow-hidden">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6">
              <div class="flex items-center">
                ...
                <span class="px-3 py-1 bg-purple-900/50 text-purple-300 text-sm rounded-full border border-purple-800">
                  {{ profile.distance }} km
                </span>
              </div>
            </div>
      ...
      <!-- Match Indicator -->
      <div v-if="showMatch" class="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
        <div class="bg-gray-800 p-8 rounded-2xl text-center max-w-sm">
          <div class="w-24 h-24 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-6">
            <HeartIcon class="h-12 w-12 text-white" />
          </div>
          <h3 class="text-2xl font-bold text-white mb-2">It's a Match!</h3>
          <p class="text-gray-300 mb-6">You and {{ matchName }} have liked each other</p>
          <button 
...
export default {
  ...
  setup() {
    ...
    const swipe = (direction) => {
      ...
      console.log(`${direction === 'right' ? 'Liked' : 'Passed on'}:`, currentProfile.name);
    ...
    const loadMoreProfiles = () => {
      // In a real app, this would fetch more profiles from an API
      const newProfiles = [
        {
          id: Date.now(),
          ...
          distance: 4.5,
          experience: 4,
          bio: 'Creative designer passionate about creating beautiful and functional user interfaces. Strong advocate for accessibility and inclusive design.',
          skills: ['UI Design', 'User Research', 'Prototyping', 'Figma', 'Design Systems'],
        ...
        },
        {
          ...
          distance: 6.2,
          experience: 7,
          bio: 'Frontend specialist with a passion for building responsive and performant web applications. Love working with modern JavaScript frameworks and tools.',
