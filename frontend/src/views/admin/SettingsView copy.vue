          ...
          <dl class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            >
              ...
              <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                <!-- Text Input -->
                <input
                  v-if="!['boolean', 'select', 'password', 'textarea'].includes(setting.type)"
                ...
                <div v-else-if="setting.type === 'boolean'" class="flex items-center">
                  <input
                    ...
                    :true-value="true"
                    :false-value="false"
                    class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 disabled:opacity-50"
                  >
                ...
                <div v-else-if="setting.type === 'password'" class="relative rounded-md shadow-sm">
                  <input
                    ...
                    type="password"
                    :disabled="isLoading"
                    class="block w-full pr-10 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white sm:text-sm disabled:opacity-50"
