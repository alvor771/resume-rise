<template>
  <div
    class="transition-colors duration-300 bg-gray-50 dark:bg-gray-900"
  ...
  <div class="container mx-auto px-4 py-8">
    <!-- Welcome Banner -->
    <div
      class="bg-gradient-to-r from-indigo-500 to-purple-600 dark:from-indigo-700 dark:to-purple-800 rounded-lg p-6 mb-6 shadow-lg"
    >
      <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div class="text-white">
          <div class="flex items-center">
            ...
            <span
              class="ml-2 px-2 py-1 text-xs bg-white/20 rounded-full animate-pulse"
              >Live</span
            >
          </div>
          ...
          <div class="mt-3 flex items-center space-x-2 text-sm">
            <span class="flex items-center">
              <span
                class="w-2 h-2 rounded-full bg-green-400 mr-1 animate-pulse"
              ></span>
      ...
      <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <div class="p-5 bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          <div class="h-64">
            ...
            <div
              v-else-if="isLoading"
              class="fixed inset-0 flex items-center justify-center bg-white dark:bg-gray-900 z-50 transition-opacity duration-300"
            >
              <div
            ...
            <div
              v-else-if="error"
              class="fixed inset-0 flex items-center justify-center bg-white dark:bg-gray-900 z-50 p-4"
            >
            ...
            <div
              v-else
              class="h-full flex items-center justify-center bg-gray-50 dark:bg-gray-700 rounded-md"
            >
              <div class="text-center">
                <div class="animate-pulse">
                  <div
                    class="h-12 w-12 mx-auto bg-gray-200 dark:bg-gray-600 rounded-full"
                  ></div>
  ...
  setup() {
    ...
    const initDashboard = async () => {
      try {
        ...
        // Initialize your dashboard data here
    ...
    // Initialize dark mode and dashboard data
    onMounted(() => {
      if (isDarkMode.value) {
        document.documentElement.classList.add("dark");
      }
    ...
    // Template for the chart tooltip (unused in current implementation)
    ...
    // Handle WebSocket messages (unused in current implementation)
    ...
    onMounted(async () => {
      try {
        ...
        // Load initial data
        await Promise.all([refreshDashboard(), fetchChartData()]);
